...
public class AdminDashboard extends JFrame {
    ...
    public AdminDashboard(String adminName, String adminEmail) {
        ...
        setBounds(175, 50, 1000, 600);
        setVisible(true);
        setResizable(false);
        setDefaultCloseOperation(DO_NOTHING_ON_CLOSE); // Changed from EXIT_ON_CLOSE
        ...
        /////////////////////////////////////////////////// SIDEBAR SECTION
        sidebar = new JPanel();
        sidebar.setBounds(0, 0, 200, 561);
        sidebar.setBackground(new Color(41, 57, 80)); // Dark blue-gray
        sidebar.setLayout(new GridLayout(7, 1, 15, 15));
        sidebar.setBorder(BorderFactory.createEmptyBorder(30, 10, 30, 10));

		//Colors
		Color activeColor = new Color(255, 204, 0);      // Yellow for active
		Color hoverColor = new Color(70, 70, 70);   // Hover effect
		Color defaultBg = new Color(45, 45, 45);    // Background of sidebar
		...
		// Set default selected tab style
        ...
        mainPanel.setBounds(200, 0, 800, 571);
        ...
        tabbedPane.setBounds(2, -22, 780, 580); // the y should be -22 for the final output
     ...
     // Set column widths (adjust as needed)
		...
		adempsub.setBounds(396, 487, 139, 28);
        pane3.add(adempsub);
        ...
        update3.setBounds(545, 487, 105, 28);
        pane3.add(update3);
